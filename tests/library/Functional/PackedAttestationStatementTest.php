...
final class PackedAttestationStatementTest extends AbstractTestCase
{
    ...
    public function aPackedAttestationCanBeVerified(): void
    {
        ...
        static::assertSame(124, $authenticatorData->signCount);
    ...
    public function aPackedAttestationWithSelfStatementCanBeVerified(): void
    {
        ...
        $authenticatorData = $publicKeyCredential->response
            ...
            ->authData;
        static::assertSame(
            hex2bin('b485db6e04882ec5871db474163925f7a5f844e6582ef56d3a8a4158242802aa'),
            $authenticatorData->rpIdHash
        );
        static::assertTrue($authenticatorData->isUserPresent());
        ...
        static::assertSame(0, $authenticatorData->getReservedForFutureUse1());
        static::assertSame(0, $authenticatorData->getReservedForFutureUse2());
        static::assertSame(1_548_688_135, $authenticatorData->signCount);
        static::assertInstanceOf(AttestedCredentialData::class, $authenticatorData->attestedCredentialData);
        static::assertFalse($authenticatorData->hasExtensions());
    }
    ...
    public function p2(): void
    {
        ...
        static::assertSame(0, $authenticatorData->getReservedForFutureUse1());
        static::assertSame(0, $authenticatorData->getReservedForFutureUse2());
        static::assertSame(105, $authenticatorData->signCount);
        static::assertInstanceOf(AttestedCredentialData::class, $authenticatorData->attestedCredentialData);
        static::assertFalse($authenticatorData->hasExtensions());
    }
}
